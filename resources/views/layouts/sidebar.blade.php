    ...
    <div class="card-body">
        <div id="EmailBox">
            <div class="" id="Inbox" role="tabpanel" aria-labelledby="Inbox-tab">
                <div class="">
                    <a href="javascript:void(0)" class="list-group-item border-0 text-blue dark:text-blue font-medium p-2 rounded-md bg-slate-50 dark:bg-slate-700 dark:text-slate-300 active flex space-x-3">
                        <img class="h-9 w-9 rounded-full" src="{{ asset('assets/images/users/avatar-1.jpg') }}" alt="user photo" />
                        <span>
                            Admin
                        </span>
                    </a>
