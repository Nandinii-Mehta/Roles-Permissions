                        ...
                        <table class="table-auto min-w-full">
                            <thead>
                                <tr class="bg-gray-400 text-center">
                                    ...
                                    <th class="text-sm font-medium text-white px-3 py-3 border-l border-transparent">
                                        I.Version</th>
                                    <th class="text-sm font-medium text-white px-3 py-3 border-l border-transparent">Buyer
                                    </th>
                                    <th class="text-sm font-medium text-white px-3 py-3 border-l border-transparent">
                                        Activated Domain</th>
                                    <th class="text-sm font-medium text-white px-3 py-3 border-l border-transparent">Last
                                        Validate Request</th>
                                    <th class="text-sm font-medium text-white px-3 py-3 border-l border-transparent">Action
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($data as $dt)
                                    <tr>
                                        ...
                                        <td class="text-center py-2 px-3 bg-slate-50 border-b">
                                            <span
                                                class="bg-red-100 text-red-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-900">{{ $dt->installed_version }}</span>
                                        </td>
                                        ...
                                        <td class="text-center py-2 px-3 bg-white border-b">{{ $dt->last_validate_request }}
                                        </td>
