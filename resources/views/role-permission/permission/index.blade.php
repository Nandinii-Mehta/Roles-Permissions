...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4">
            <a href="{{route('permissions.create')}}" class="bg-gray-500 px-3 mb-2 py-2 text-sm text-white inline-block rounded hover:bg-gray-800 hover:text-white">
                Add Permission
            </a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="flex space-x-2 justify-center text-center text-dark py-2 px-3 bg-slate-50 dark:bg-slate-900/20 dark:text-slate-300 border-b border-[#E8E8E8] dark:border-slate-900">
                                        <a href="{{route('permissions.edit',$permission->id)}}" class="border border-gray-500 px-3 py-2 text-sm text-gray-500 inline-block rounded hover:bg-gray-500 hover:text-white">
                                            Edit
                                        </a>
